...
## スケジュール
スケジュールについては参考例であり、デプロイ以外のチェックリストのタスクを１周目（4/19）までに完了していれば構いません。

```
7/19: チームのリポジトリの作成、チームで自習室に集まりアイスブレイクと課題を行う日程を決める、個人でのGit学習
7/20: 個人でのGit学習
7/21: 自習室に集まり、課題1を着工（1回目）
7/22: 個人でのGit学習
7/23: 自習室に集まり、課題1を着工（2回目）
7/24: チームで作成する成果物を決定
7/25: チームメンバーが課題の内容を理解している状態、チェックリスト（リポジトリ）の提出
7/26: チーム開発着工
~~
8/03成果物提出
```
